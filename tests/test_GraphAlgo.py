...
class TestGraphAlgo(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.graph.add_node(2, (5, 10))
        self.graph.add_node(3, (12, 7))
        self.graph.add_node(4, (2, 4))
        self.graph.add_node(5, (4, 9))
        self.graph.add_node(6, (8, 6))
        self.graph.add_node(7, (18, 7))
        self.graph.add_node(8, (7, 16))
        self.graph.add_node(9, (20, 5))
        self.graph.add_node(10, (9, 18))
