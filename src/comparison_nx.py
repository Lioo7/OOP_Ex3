...
if __name__ == '__main__':
    ...
    for x in range(0, iterations):
        ...
        for i in range(0, 18):
            nx_results_total[i] = (nx_results_total[i] + nx_results[i])
            py_results_total[i] = (py_results_total[i] + py_results[i])
            java_results_total[i] = (java_results_total[i] + java_results[i])
